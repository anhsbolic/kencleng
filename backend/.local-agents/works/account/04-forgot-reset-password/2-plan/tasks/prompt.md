Read .local-agents/works/account/04-forgot-reset-password/2-plan/techplan.md
...
- write files in .local-agents/works/account/04-forgot-reset-password/2-plan/tasks
