You are exploring a task in this codebase: "Kencleng — Go backend". This happens in three stages — do not skip or merge them.

Working directory for this task: /home/anhar-solehudin/kencleng-workspace/kencleng/backend/.local-agents/works/account/08-role-assignment — write all raw output
from every stage below into /home/anhar-solehudin/kencleng-workspace/kencleng/backend/.local-agents/works/account/08-role-assignment/1-exploration/logs/ (see root
README.md § Task Working Directory Structure).

Guidance folder for this phase: /home/anhar-solehudin/kencleng-workspace/harscode-workspace/workflow/1-exploration
...
**Task:** /home/anhar-solehudin/kencleng-workspace/kencleng/docs/spec/1-account/features/08-role-assignment.md

**Area (if known):** "not sure yet — help me figure out the areas"
...
stage into /home/anhar-solehudin/kencleng-workspace/kencleng/backend/.local-agents/works/account/08-role-assignment/1-exploration/logs/ — the shape should follow the content, not a preset template.