...
now you are exploring a task for feature 03-login-session-management, read /home/anhar-solehudin/kencleng-workspace/kencleng/docs/spec/README.md then read /home/anhar-solehudin/kencleng-workspace/kencleng/docs/spec/domains/account/features/03-login-session-management.md.
...
stage inside /home/anhar-solehudin/kencleng-workspace/kencleng/backend/.local-agents/works/account/03-login-session-management/1-explore/logs — the shape should follow the content, not a preset template.