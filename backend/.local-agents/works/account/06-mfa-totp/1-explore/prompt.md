...
stage inside /home/anhar-solehudin/kencleng-workspace/kencleng/backend/.local-agents/works/account/06-mfa-totp/1-explore/logs — the shape should follow the content, not a preset template.