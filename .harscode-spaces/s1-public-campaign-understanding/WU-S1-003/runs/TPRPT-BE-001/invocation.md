# TPRPT-BE-001 — Human Techplan Report Generation
...
RUN_PATH:
`.harscode-spaces/s1-public-campaign-understanding/WU-S1-003/runs/TPRPT-BE-001`
...
Write:
`.harscode-spaces/s1-public-campaign-understanding/WU-S1-003/runs/TP-BE-001/report-techplan.md`
