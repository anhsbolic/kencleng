# CR-TOP-001 — Code Review Invocation
...
RUN_PATH:
`.harscode-spaces/s1-public-campaign-understanding/WU-S1-005/runs/CR-TOP-001`
...
SPECIALIZATION:
`Independent Code Review — Root topology Caddy/MinIO policy`
...
CURRENT_DIFF_SCOPE:
Caddyfile, docker-compose.yml, and docs/project/kencleng-repo-setup.md changes produced by BLD-TOP-001
