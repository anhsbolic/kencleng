...
- Frontend stack: `kencleng-frontend-tech-stack.md`
- Actors, roles, entities: `kencleng-actors-entities.md`
- Business process overview: `kencleng-business-process-overview.md`
- Detailed feature specs: `kencleng-phase0-detail.md` (foundational:
  auth, MFA, notification, file storage, ToS, audit log),
  `kencleng-phase1-detail.md` (pre-campaign),
  `kencleng-phase2-detail.md` (on-campaign),
  `kencleng-phase3-detail.md` (post-campaign)
- Sequencing/tracking: `kencleng-roadmap-next-steps.md`