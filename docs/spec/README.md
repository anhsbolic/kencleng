...
|---|---|---|---|
| Domain invariant | `docs/spec/domains/<domain>-invariants.md` | Once per domain, stable | Anhar (with drafting help from an agent), must be human-reviewed |
| Threat model | `docs/spec/threat-model/<domain>.md` | Once per domain, revised on domain-level changes | Same as above |
| Feature spec | `docs/spec/features/<fitur>.md` | New for each vertical slice/endpoint | Same as above, per feature |
...
`docs/spec/domains/<domain>-invariants.md`
...
`docs/spec/threat-model/<domain>.md`
...
- `docs/spec/domains/<domain>-invariants.md#INV-<domain>-01`
 
## Threat breakdown
 
Derived from `docs/spec/threat-model/<domain>.md`, narrowed down to
